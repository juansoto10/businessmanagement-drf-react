...
const Home = ({
  ...
  return (
    <FullWidthLayout>
      <div className="flex flex-col justify-center items-center w-screen bg-gradient-to-r from-purple-mid to-misty p-6 md:min-h-cool" >
        <h1 className="text-5xl sm:text-6xl xl:text-8xl font-bold text-purple w-5/6 lg:w-fit mb-20 drop-shadow-lg text-center">
          Welcome to Your Business Management App!
        </h1>
